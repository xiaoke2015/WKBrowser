...
//        _textField.alpha = 0.6 + (0.4*scale);
        
        CGFloat color = 255 - 15*scale;
        
        _textField.backgroundColor = RGBA(color, color, color, 0.6 + (0.2*scale));
        _textField.frame = CGRectMake(20 - 25*scale, SCREEM_WIDTH*0.3, SCREEM_WIDTH - 40 + 50*scale, 44);
