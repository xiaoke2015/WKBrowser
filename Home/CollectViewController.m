...
- (void)btnAction {
    ...
    [[RecordDataBase alloc] delCollAll];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(cell == nil){
        ...
        cell.imageView.image = [UIImage imageNamed:@"pop_btn_002"];
    }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [searchBarView.currentWebViewVC loadReqWithURL:model.url];
...
- (void)loadData {
    ...
    [[RecordDataBase alloc] queryCollData:^(NSArray * _Nullable objects, NSError * _Nullable error) {
