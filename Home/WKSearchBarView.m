...
- (void)creatBtns {
    ...
    _pageLabel = [[UILabel alloc]initWithFrame:CGRectMake(w*0.03, -self.height*0.07, w, self.height)];
    _pageLabel.textAlignment = NSTextAlignmentCenter;
    _pageLabel.font = FONT10;
...
//    NSString * string = [NSString stringWithFormat:@"https://itunes.apple.com/cn/app/id%@?mt=8",APPSTOREID];
    ...
    NSString * string = self.currentWebView.URL.absoluteString;
