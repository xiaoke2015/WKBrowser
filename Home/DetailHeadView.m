...
- (void)creatView {
    ...
    _commentBar = [[UIView alloc]initWithFrame:CGRectMake(0, _detail.bottom + 10, SCREEM_WIDTH, 80)];
    
    [self addSubview:_commentBar];
    
    
    UILabel *label = [[UILabel alloc]initWithFrame:CGRectMake(15, 40, 100, 40)];
    label.text = @"最新评论";
    ...
    UIButton *btn = [[UIButton alloc]initWithFrame:CGRectMake(SCREEM_WIDTH/2 - 50, 0, 100, 40)];
    [btn setTitleColor:RGB(200, 200, 200) forState:UIControlStateNormal];
    [btn setTitle:@"原文链接" forState:UIControlStateNormal];
    btn.titleLabel.font = FONT14;
    [_commentBar addSubview:btn];
//    btn.contentHorizontalAlignment = UIControlContentHorizontalAlignmentRight;

    UILabel *line = [[UILabel alloc]initWithFrame:CGRectMake(0, 80, SCREEM_WIDTH, 0.5)];
...
- (void)dataWithModel:(MessageModel*)model {
    ...
    _commentBar.frame = CGRectMake(0, _detail.bottom +10, SCREEM_WIDTH, 80);
    
    self.frame = CGRectMake(0, 0, SCREEM_WIDTH, _detail.bottom + 90);
