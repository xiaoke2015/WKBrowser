...
- (void)creatView {
    ...
    _imgView = [[UIImageView alloc]initWithFrame:CGRectMake(15, 10, 100, 70)];
    ...
    _title = [[UILabel alloc]initWithFrame:CGRectMake(130, 10, SCREEM_WIDTH - 140, 20)];
    _title.font = [UIFont fontWithName:@"Helvetica-Bold" size:16];
    _title.numberOfLines = 2;
    //    _title.textColor = RGB(50, 50, 50);
    [self.contentView addSubview:_title];
    
    _mark = [[UILabel alloc]initWithFrame:CGRectMake(130, 60, SCREEM_WIDTH - 140, 20)];
