...
//居中卡片宽度与据屏幕宽度比例
static float CardWidthScale = 0.6f;
static float CardHeightScale = 0.6f;

@implementation DWebCardFlowLayout
...
- (float)cellMargin {
    ...
    return (self.collectionView.bounds.size.width - [self cellWidth])/8;
}
