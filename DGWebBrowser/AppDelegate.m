...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    bootPage.successBlock = ^{
        ...
        KKRootViewController *tabBar = [[KKRootViewController alloc]init];
        
        self.window.rootViewController = [[JKBaseNavigationController alloc]initWithRootViewController:tabBar];
    };
