...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    bootPage.successBlock = ^{
        ...
        WKRootViewController *tabBar = [[WKRootViewController alloc]init];
...
//    NSString *open = NSLocalizedStringFromTable(@"isopen",@"InfoPlist", nil);
    ...
    BOOL isopen = YES;// [open boolValue];
...
- (void)creatShortcutItem {
    ...
    //创建快捷选项
    UIApplicationShortcutItem * item = [[UIApplicationShortcutItem alloc]initWithType:@"com.yang.share" localizedTitle:@"分享" localizedSubtitle:APPName icon:icon userInfo:nil];
...
#pragma mark  TalkingData appkey
    [TalkingData sessionStarted:TDataKey withChannelId:channelId];
}
