...
- (void)setupNavigationBar {
    ...
    [left_Button setTitleColor:RGB(50, 50, 50) forState:(UIControlStateNormal)];
    ...
    self.navigationController.navigationBar.titleTextAttributes = @{NSForegroundColorAttributeName:RGB(50, 50, 50)};
...
- (void)QRCodeScanManager:(SGQRCodeScanManager *)scanManager didOutputMetadataObjects:(NSArray *)metadataObjects {
    ...
    if (metadataObjects != nil && metadataObjects.count > 0) {
        ...
        NSString *scanWords = [obj stringValue];
...
//        [self.navigationController pushViewController:jumpVC animated:YES];
        ...
        [HUDManager alertText:@"暂未识别出扫描的二维码"];
    }
}
