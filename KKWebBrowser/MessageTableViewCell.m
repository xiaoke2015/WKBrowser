...
- (void)dataWithModel:(MessageModel*)model {
    ...
    if(type == 0){
        ...
        _title.frame = CGRectMake(130, 10, SCREEM_WIDTH - 140, 20);
        
        [_title sizeToFit];
        _title.frame = CGRectMake(130, 10, SCREEM_WIDTH - 140, _title.height);
        
        _imgView.frame = CGRectMake(15, 10, 100, 70);
        _mark.frame = CGRectMake(130, 60, SCREEM_WIDTH - 140, 20);
        
        self.frame = CGRectMake(0, 0, SCREEM_WIDTH, 90);
    }
    else if (type == 2){
        
        _title.frame = CGRectMake(15, 10, SCREEM_WIDTH - 140, 20);
        
        [_title sizeToFit];
        _title.frame = CGRectMake(15, 10, SCREEM_WIDTH - 140, _title.height);
        
        _imgView.frame = CGRectMake(SCREEM_WIDTH - 115, 10, 100, 70);
        _mark.frame = CGRectMake(15, 60, SCREEM_WIDTH - 140, 20);
